...
#	print >> out_file, "no_extremes.molten$variable <- 1:50"
	print >> out_file, "psmooth <- ggplot(exp.molten, aes(y=value, x=variable, fill=\"#00AA93\"))"
	print >> out_file, "psmooth <- psmooth + stat_smooth(method = \"lm\", formula = y ~ poly(x, 3), size = 1) + ggtitle(\"" + name + "\") + theme_grey(base_size = 15) + ylim(-1,1) + theme(legend.position=\"none\")"
...
def fixMissingCycles(PLATE1, PLATE2, PLATE3, PLATE4, PLATE5, PLATE6, PLATE7, PLATE8):
	del PLATE1[4:6]
	del PLATE1[19]
	del PLATE1[50]
	del PLATE2[28]
	...
	PLATE6.pop()
	PLATE8.pop()	
	return PLATE1, PLATE2, PLATE3, PLATE4, PLATE5, PLATE6, PLATE7, PLATE8
...
PLATE1, PLATE2, PLATE3, PLATE4, PLATE5, PLATE6, PLATE7, PLATE8 = fixMissingCycles(PLATE1, PLATE2, PLATE3, PLATE4, PLATE5, PLATE6, PLATE7, PLATE8)
